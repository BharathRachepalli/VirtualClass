...
<c:set var="data" value="${welcomeNote}" />
	...
	<input type="button" value="Display Students"
		onclick="window.location.href='DisplayStudentsForStaff.jsp'; return false;"
...
<h2>Display Staff</h2>
	...
	<h2>Download Student Assignment</h2>

	 <input type="button" value="Download Assignment"
		onclick="window.location.href='DownLoadStudentAssig.jsp'; return false;"
		class="add-student-button btn" />
